...
export const ui = {
  ...
  fr: {
    ...
    'work.strip.title': 'Des marques qui nous ont confié ce travail',
  ...
  de: {
    ...
    'footer.col.tools': 'Kostenlose Rechner',
    'work.strip.eyebrow': 'Aus der Praxis',
    'work.strip.title': 'Marken, die uns genau das anvertraut haben',
    'work.strip.all': 'Alle Referenzen ansehen',
  ...
  es: {
    ...
    'work.strip.title': 'Marcas que ya nos han confiado este trabajo',
    'work.strip.all': 'Ver todos los proyectos',
