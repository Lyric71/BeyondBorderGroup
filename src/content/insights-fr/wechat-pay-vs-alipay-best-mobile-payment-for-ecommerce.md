...
En Chine, deux acteurs concentrent l'essentiel des flux de paiement mobile : WeChat Pay et Alipay. Le cash a disparu, l'écran l'a remplacé. Chacun avec ses spécificités, ses forces, ses logiques. Lire précisément ce qui les sépare permet à une marque de greffer la bonne solution sur son parcours e-commerce.

## WeChat Pay : présentation et usages

### Qu'est-ce que WeChat Pay ?

[WeChat](/fr/se-developper-en-chine/commerce-social) Pay, signé Tencent, tient le centre du paiement mobile chinois. Intégré nativement à WeChat, il transforme la messagerie sociale en super-app multifonction. Lancé en août 2013, il sert aujourd'hui plus d'un milliard d'utilisateurs et a redessiné la manière dont les Chinois règlent leurs achats.
...
### Mettre en place WeChat Pay côté entreprise

Pour la marque qui veut adresser la base utilisateur de WeChat Pay, l'ouverture d'un compte constitue un mouvement stratégique. Les étapes :

1. **Créer un compte officiel** : la marque dépose son dossier, fournit les pièces justificatives et passe la vérification.
2. **Retenir un profil professionnel** : selon le projet, on opte pour un compte Subscription ou un compte Service. Le second convient mieux à un usage [e-commerce](/fr/se-developper-en-chine/ecommerce-transfrontalier) avec WeChat Pay.
...
Alipay, propriété d'Alibaba, est le pionnier du paiement mobile chinois. Lancé en 2004, il s'est hissé parmi les plateformes de paiement les plus utilisées au monde. 652,4 millions d'utilisateurs actifs mensuels, et une gamme de services financiers qui déborde largement le paiement.
...
### Mettre en place Alipay côté entreprise

Pour exploiter Alipay côté marque :

1. **Créer un profil marchand** : la première étape passe par l'ouverture d'un compte marchand depuis un compte Alipay existant. Documents d'entreprise et justificatifs financiers à fournir pour la vérification.
...
* **Opportunités marketing** : la plateforme aligne des leviers de publicité ciblée et de promotion. Remises, programmes de fidélité, offres exclusives : autant d'outils pour générer trafic et ventes.

## WeChat Pay et Alipay : les différences clés

### Social et e-commerce

WeChat Pay excelle dans le mariage entre social et commerce. Ses mini-programmes ouvrent une interaction directe avec l'utilisateur depuis l'environnement social. Alipay, lui, se concentre sur la dimension e-commerce pure, fort de son ancrage Alibaba.

### Expérience utilisateur

Les deux plateformes offrent un usage fluide. WeChat Pay séduit en particulier la jeune génération, qui valorise l'interaction sociale. Alipay reste imbattable côté écosystème financier, pour l'utilisateur qui veut gérer plus que ses achats.

### Profils utilisateurs

Les deux plateformes touchent une base utilisateur massive. WeChat Pay, par son ancrage social, parle surtout aux jeunes adultes. Alipay capte une tranche d'âge plus large grâce à son offre financière étendue.

### Paiements internationaux

Les deux solutions gèrent les paiements internationaux. WeChat Pay, fort de sa dimension sociale, ouvre des opportunités spécifiques pour cibler le touriste chinois à l'étranger. Alipay, présent dans 300 villes et adossé à Alibaba, reste idéal pour les marques tournées vers le e-commerce et les services financiers.
