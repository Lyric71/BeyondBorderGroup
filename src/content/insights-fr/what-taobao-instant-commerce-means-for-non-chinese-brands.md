...
description: "Avec Taobao Instant Commerce et le rebranding d'Ele.me en Taobao Flash Sale, Alibaba dépasse la logique festive de Double 11 pour installer la livraison instantanée dans le quotidien. Une recomposition qui rebat les cartes pour les marques étrangères."
pubDate: "2025-11-21"
...
Cette édition a tourné autrement. Avec [Taobao](/fr/se-developper-en-chine/ecommerce-transfrontalier) Instant Commerce et le rebranding d'Ele.me en Taobao Flash Sale, Alibaba vise au-delà du GMV de novembre. Le groupe veut réapprendre aux Chinois à faire leurs courses au quotidien. La livraison instantanée quitte son statut de produit annexe d'une application de livraison de repas. Elle entre dans le cœur de l'expérience Taobao.

Pour les marques non chinoises, la vraie question dépasse une campagne ponctuelle. Il s'agit de planifier dans un monde où le e-commerce chinois ressemble de plus en plus à la livraison de repas.

## Ce qu'Alibaba construit réellement

[Taobao](/fr/se-developper-en-chine/ecommerce-transfrontalier) Instant Commerce structure la livraison à l'heure de Taobao en une grille unique alimentée par les coursiers Ele.me, les magasins Freshippo et les supermarchés partenaires. Elle couvre désormais les essentiels du quotidien, une partie de l'électronique et de la mode, à hauteur de dizaines de millions de commandes instantanées par jour.

Taobao Flash Sale sert de porte d'entrée. L'application Ele.me change de nom. Les coursiers deviennent des « chevaliers de la ville ». Le bleu emblématique de la livraison de repas glisse progressivement vers l'orange Taobao.

En coulisses, Alibaba a rapatrié le retail temps réel dans sa division e-commerce principale. Le commerce instantané n'est plus un projet périphérique. Il s'intègre à l'offre centrale de Taobao.

Subventions massives et investissements ont fait grimper les volumes très vite, sous pression des marges pour toute la filière. Cette bataille porte sur la part de marché et l'habitude. Pas sur le résultat trimestriel propre.
...
L'utilisateur parcourt, compare, met dans son panier, puis attend Double 11 ou 6.18 pour valider. Grosses commandes, quelques fois par an.
...
En intégrant la livraison instantanée à Taobao et en rebrandant Ele.me en Taobao Flash Sale, Alibaba cherche à fusionner ces deux comportements. L'objectif dépasse Double 11. Il consiste à :

* Créer des points de contact quotidiens à la place de quelques pics festifs.
* Faire monter la fréquence d'achat par utilisateur, et plus seulement le panier moyen.
* Habituer le consommateur à attendre une livraison rapide sur de nombreuses catégories, pas seulement les repas.
...
À court terme, les gains de l'instant commerce restent concentrés sur les acteurs locaux, dans les catégories d'impulsion et avec des réseaux de magasins denses. Pour nombre de marques internationales, les barrières opérationnelles et financières demeurent élevées.

La direction stratégique, en revanche, est posée :
...
* Lire Double 11 et le trimestre qui suit comme un diagnostic des attentes de rapidité dans votre catégorie.
...
* Concentrer l'effort sur la communauté, le récit et un positionnement distinct sur Douyin et Xiaohongshu, où le ton et l'adéquation produit comptent encore plus que la vitesse seule.
...
* Concentrer l'investissement sur le search et la mise en visibilité chez Tmall et Taobao, et traiter toute activité d'instant commerce comme une expérience de visibilité, pas comme un moteur de volume.
...
Chez BeyondBorderGroup, voilà précisément le terrain sur lequel nous accompagnons nos clients, en reliant une intention globale à la réalité locale chinoise qui bouge vite. La question pratique à laquelle nous revenons toujours reste simple.
