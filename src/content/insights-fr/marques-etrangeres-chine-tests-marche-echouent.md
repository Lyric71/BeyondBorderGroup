...
keyTakeaways:
  - "Le cross-border avale 30 à 40 % du chiffre d'affaires visé en année une, une fois additionnés forfait TP, commissions, frais de plateforme, médias et logistique en zone sous douane."
  ...
  - "La Chine récompense les résidents, pas les visiteurs. Les budgets en mode projet annexe et les feuilles de route à douze mois échouent à chaque fois."
...
Le parcours type vers la Chine démarre désormais par le [cross-border](/fr/entrer-en-chine/lancement-cross-border) e-commerce, le CBEC. Aucune création de société exigée. Pas d'entité locale, pas d'entrepôt, pas d'équipe au sol. Tmall Global, JD Worldwide, Douyin, Xiaohongshu : ces plateformes ouvrent des programmes CBEC qui laissent les [marques étrangères](/fr/entrer-en-chine/conseil-en-entree-de-marche) vendre directement aux consommateurs chinois depuis l'étranger.
