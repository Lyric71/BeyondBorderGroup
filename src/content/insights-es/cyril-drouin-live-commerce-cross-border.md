...
En los próximos cinco años anticipo una convergencia de planteamientos de eCommerce entre regiones. La influencia china en las tendencias occidentales se ve a ojo: el [comercio por livestream](/es/crecer-en-china/influencia-y-kol), las superapps y el social shopping ya están ganando terreno en Occidente. Al mismo tiempo, las empresas chinas aprenden de las prácticas occidentales y se centran cada vez más en branding y en crear ventas basadas en experiencia. Podemos esperar una integración cada vez más fluida del comercio dentro de las redes sociales, mayor uso de IA para experiencias de compra personalizadas y un peso mayor de la sostenibilidad. El consumidor presta cada vez más atención al origen y al método de producción de lo que compra, y las marcas alineadas con esos valores tendrán una ventaja clara. El eCommerce cross-border irá más allá de la simple entrada en nuevos mercados para montar una experiencia de compra de verdad global e integrada.
