...
seoTitle: "PIPL Compliance in China: Dior's Wake-Up Call"
description: "Dior is the first foreign brand formally punished under China's Personal Information Protection Law. What PIPL enforcement now means for global brands."
pubDate: "2025-11-26"
...
* customers were not clearly informed or asked for separate consent
...
When core marketing platforms are hosted overseas, campaigns that rely on identified user data will typically be subject to cross-border data compliance requirements. In practice, this is why many brands consider setting up China-specific instances of their core tools, or using local solutions, so teams can still run segmented journeys and measurement while managing user data in a locally compliant way.
