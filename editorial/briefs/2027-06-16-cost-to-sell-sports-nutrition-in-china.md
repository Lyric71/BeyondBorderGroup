...
slug: cost-to-sell-sports-nutrition-in-china
primary_query: ""
...
# BRIEF 41L: What it costs to sell sports nutrition in China
...
| Field | Value |
|---|---|
| Working H1 | What it costs to sell sports nutrition in China |
| Slug | `/insights/cost-to-sell-sports-nutrition-in-china/` |
| Output file | `output/cost-to-sell-sports-nutrition-in-china.md` |
...
- [ ] File saved as `output/cost-to-sell-sports-nutrition-in-china.md`
