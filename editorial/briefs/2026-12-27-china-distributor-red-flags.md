...
slug: china-distributor-red-flags
primary_query: "china distributor red flags"
word_count: "1,600 to 2,400"
status: not_started
---

# BRIEF P47: China distributor red flags from the Compass files
...
| Field | Value |
|---|---|
| Working H1 | China distributor red flags from the Compass files |
| Slug | `/insights/china-distributor-red-flags/` |
| Output file | `output/china-distributor-red-flags.md` |
| Primary query | `china distributor red flags` |
...
- [ ] File saved as `output/china-distributor-red-flags.md`
