...
slug: tmall-global-vs-tmall-classic
primary_query: "tmall global vs tmall classic"
difficulty: HELD
word_count: "2,100 to 2,400"
status: not_started
---

# BRIEF 39A: Tmall Global or Tmall Classic: when to move onshore
...
| Field | Value |
|---|---|
| Working H1 | Tmall Global or Tmall Classic: when to move onshore |
| Slug | `/insights/tmall-global-vs-tmall-classic/` |
| Output file | `output/tmall-global-vs-tmall-classic.md` |
| Primary query | `tmall global vs tmall classic` |
| Difficulty | HELD |
...
- [ ] File saved as `output/tmall-global-vs-tmall-classic.md`
