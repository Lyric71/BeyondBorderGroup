...
slug: cost-to-sell-infant-formula-in-china
primary_query: ""
...
# BRIEF 50L: What it costs to sell infant formula in China
...
| Field | Value |
|---|---|
| Working H1 | What it costs to sell infant formula in China |
| Slug | `/insights/cost-to-sell-infant-formula-in-china/` |
| Output file | `output/cost-to-sell-infant-formula-in-china.md` |
...
- [ ] File saved as `output/cost-to-sell-infant-formula-in-china.md`
