...
slug: hong-kong-distributor-china-mainland
primary_query: "hong kong distributor china mainland"
word_count: "1,300 to 1,800"
status: not_started
---

# BRIEF P43: Hong Kong as a base for selling into mainland China
...
| Field | Value |
|---|---|
| Working H1 | Hong Kong as a base for selling into mainland China |
| Slug | `/insights/hong-kong-distributor-china-mainland/` |
| Output file | `output/hong-kong-distributor-china-mainland.md` |
| Primary query | `hong kong distributor china mainland` |
...
- [ ] File saved as `output/hong-kong-distributor-china-mainland.md`
