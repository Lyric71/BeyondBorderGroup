...
slug: tmall-partner-onboarding
primary_query: "tmall partner onboarding"
word_count: "1,300 to 1,800"
status: not_started
---

# BRIEF P26: The first 90 days with a new Tmall Partner
...
| Field | Value |
|---|---|
| Working H1 | The first 90 days with a new Tmall Partner |
| Slug | `/insights/tmall-partner-onboarding/` |
| Output file | `output/tmall-partner-onboarding.md` |
| Primary query | `tmall partner onboarding` |
...
- [ ] File saved as `output/tmall-partner-onboarding.md`
