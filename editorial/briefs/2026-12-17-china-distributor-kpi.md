...
slug: china-distributor-kpi
primary_query: "china distributor kpi"
word_count: "1,000 to 1,400"
asset: "A China distributor scorecard beyond the sales target"
asset_format: "printable page"
status: not_started
---

# BRIEF P42: A China distributor scorecard beyond the sales target
...
| Field | Value |
|---|---|
| Working H1 | A China distributor scorecard beyond the sales target |
| Slug | `/insights/china-distributor-kpi/` |
| Output file | `output/china-distributor-kpi.md` |
| Primary query | `china distributor kpi` |
...
| Asset | `output/guides/china-distributor-kpi.md`, publishes to `/guides/china-distributor-kpi/` (printable page) |
...
- [ ] File saved as `output/china-distributor-kpi.md`
