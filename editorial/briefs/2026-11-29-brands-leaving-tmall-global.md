...
slug: brands-leaving-tmall-global
primary_query: "brands leaving tmall global"
word_count: "1,300 to 1,800"
status: not_started
---

# BRIEF P28: Why brands leave Tmall Global, and what it says
...
| Field | Value |
|---|---|
| Working H1 | Why brands leave Tmall Global, and what it says |
| Slug | `/insights/brands-leaving-tmall-global/` |
| Output file | `output/brands-leaving-tmall-global.md` |
| Primary query | `brands leaving tmall global` |
...
- [ ] File saved as `output/brands-leaving-tmall-global.md`
