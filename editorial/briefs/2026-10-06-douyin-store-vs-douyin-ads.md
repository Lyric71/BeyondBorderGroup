...
slug: douyin-store-vs-douyin-ads
primary_query: "douyin store vs douyin ads"
difficulty: OPEN
word_count: "1,900 to 2,300"
status: not_started
---

# BRIEF 05A: Douyin store or Douyin as media: which one you actually need
...
| Field | Value |
|---|---|
| Working H1 | Douyin store or Douyin as media: which one you actually need |
| Slug | `/insights/douyin-store-vs-douyin-ads/` |
| Output file | `output/douyin-store-vs-douyin-ads.md` |
| Primary query | `douyin store vs douyin ads` |
| Difficulty | OPEN |
...
- [ ] File saved as `output/douyin-store-vs-douyin-ads.md`
