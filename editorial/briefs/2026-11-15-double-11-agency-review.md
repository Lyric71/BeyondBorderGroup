...
slug: double-11-agency-review
primary_query: "double 11 agency review"
word_count: "1,000 to 1,400"
asset: "The Double 11 review to run with your China partner"
asset_format: "printable page"
status: not_started
---

# BRIEF P23: The Double 11 review to run with your China partner
...
| Field | Value |
|---|---|
| Working H1 | The Double 11 review to run with your China partner |
| Slug | `/insights/double-11-agency-review/` |
| Output file | `output/double-11-agency-review.md` |
| Primary query | `double 11 agency review` |
...
| Asset | `output/guides/double-11-agency-review.md`, publishes to `/guides/double-11-agency-review/` (printable page) |
...
- [ ] File saved as `output/double-11-agency-review.md`
