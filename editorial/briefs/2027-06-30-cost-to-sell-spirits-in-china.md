...
slug: cost-to-sell-spirits-in-china
primary_query: ""
...
# BRIEF 43L: What it costs to sell spirits in China
...
| Field | Value |
|---|---|
| Working H1 | What it costs to sell spirits in China |
| Slug | `/insights/cost-to-sell-spirits-in-china/` |
| Output file | `output/cost-to-sell-spirits-in-china.md` |
...
- [ ] File saved as `output/cost-to-sell-spirits-in-china.md`
